...
def get_source_type(filename: str) -> str:
    ...
    first_aid_keywords = [
        # === ИЗНАЧАЛЬНЫЕ (все 11 слов) ===
        "мчс", "ожог", "кровотеч", "слр", "реанимац", "травм",
        "перелом", "обморож", "помощь", "477н", "первая",
    
        # === ТРАВМЫ И ПОВРЕЖДЕНИЯ ===
        "порез", "ушиб", "вывих", "растяж", "сотряс", "рана",
        "раневой", "ранения", "кровь", "жгут", "турникет", "давящ",
        "повязк", "бинт", "ожогов", "отморож", "холодов", "гипотерм",
        "переломов", "иммобилиз", "шин", "ампутац", "разрыв", "проникающ",
    
        # === РЕАНИМАЦИЯ И ЖИЗНЕННЫЕ ФУНКЦИИ ===
        "реанимацион", "сердечн", "легочн", "дыхан", "остановк", "сердц",
        "непрям", "массаж", "дефибрилл", "искусств", "вентиляц", "рот",
        "инородн", "аспирац", "пульс", "сознан", "дыхани",
    
        # === НЕОТЛОЖНЫЕ СОСТОЯНИЯ ===
        "эпилепс", "судорог", "припад", "обморок", "кома", "шок",
        "анафилакс", "аллерг", "гипоглик", "инсульт", "инфаркт",
        "отравлен", "утоплен", "электротравм", "поражен",
    
        # === УКУСЫ И ВНЕШНИЕ ВОЗДЕЙСТВИЯ ===
        "укус", "змей", "насеком", "клещ",
    
        # === ЧС, СПАСЕНИЕ, МЕДИЦИНА КАТАСТРОФ ===
        "дтп", "авари", "чс", "катастроф", "эвакуац", "пострадав",
        "скорая", "врач", "фельдшер", "медсестр", "террорист", "взрыв",
    
        # === СРЕДСТВА И АПТЕЧКА ===
        "аптечк", "гемостатик", "гемостаз", "порошок",
    
        # === ДОКУМЕНТЫ И ОРГАНИЗАЦИИ ===
        "приказ 477", "красный крест", "медицина катастроф", "вцмк",
    
        # === АЛГОРИТМЫ И ДЕЙСТВИЯ ===
        "алгоритм", "действия", "экстренн", "осмотр", "жизненн",
        "симптом", "признак", "правила", "памятк", "сердечно-легочн",
    
        # === ОСЛОЖНЕНИЯ И СПЕЦСОСТОЯНИЯ ===
        "геморрагическ", "травматическ", "пневмоторакс", "гемоторакс",
        "дренаж", "окклюз", "клапан",
    
        # === МЕЖДУНАРОДНЫЕ ПРОТОКОЛЫ ===
        "helo", "abcd", "abcde", "cabc",
    ]
